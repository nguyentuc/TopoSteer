...
if __name__ == "__main__":
    ...
    for task in ['cognitive-enhancement']:
        print("\n" + "="*100)
        ...
        for num_layers in [1, 3, 5]:
            ...
            # ========================================================
            print(f"[Strategy 2: Testing ALL {len(ALL_VARIANTS_FLAT)} TSS Variants × 7 Distance Metrics]")
            ...
            for category_name, variant_list in ALL_TSS_VARIANTS.items():
                ...
                for variant_name in variant_list:
                    ...
                    for metric in ALL_HOLE_METRICS:
                        ...
                        print(f"    {metric:25s}: Prob={test_prob:.4f} (delta={delta:+.4f}) | Layers={top_layers}")
            ...
            for rank, (name, result) in enumerate(sorted_strategies[:30], 1):
                ...
                print(f"  {rank:2d}. {name:60s} | Prob={prob:.4f} (Δ={delta:+.4f}) | Layers={layers}")
